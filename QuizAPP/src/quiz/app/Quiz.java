...
//        add(image);
        try {
            ...
            if (i1 != null) {
                // Create and add JLabel with the loaded image
                JLabel image = new JLabel(i1);
                image.setBounds(0, 0, 1440, 392);
                add(image);
            } else {
        ...
        submit.setBackground(new Color(250, 100, 0));
       ...
       // previous.setBounds(1150, 800, 200, 30);
       // previous.setForeground(Color.BLACK);
       // previous.setFont(new Font("Tahoma", Font.PLAIN, 18));
        //previous.setBackground(new Color(255, 215, 0));
        /*previous = new JButton("Previous");
        previous.setBounds(470, 750, 200, 30);
        previous.setFont(new Font("Tahoma", Font.PLAIN, 18));
        previous.setBackground(new Color(22, 99, 54));
        previous.setForeground(Color.WHITE);
        previous.addActionListener(this);
       // previous.setEnabled(false); // Initially disabled until there's a question to go back to
        add(previous);
